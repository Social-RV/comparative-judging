...
class SocialRVClient:
    ...
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None):
        ...
        self.base_url = (
            base_url or os.getenv("SOCIAL_RV_API_URL", "https://social-rv.com")
        ).rstrip("/")
    ...
    def _request(
        self, method: str, endpoint: str, params: Optional[Dict[str, Any]] = None, timeout: int = 60
    ) -> Dict[str, Any]:
        """Make an API request."""
    ...
    def get_sessions_by_ids(self, session_ids: List[str]) -> Dict[str, Any]:
        ...
        data = self._request("GET", "/api/research/sessions", params={"ids": ",".join(session_ids)})
    ...
    def get_targets_by_ids(self, target_ids: List[str]) -> Dict[str, Any]:
        ...
        data = self._request("GET", "/api/research/targets", params={"ids": ",".join(target_ids)})
    ...
    def get_session_with_decoys(self, session_id: str) -> Dict[str, Any]:
        ...
        return {"session": session, "target": target, "decoys": decoys}
